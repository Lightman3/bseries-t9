...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Serie.count') do
      post series_url, params: { series: { category: @series.category, description: @series.description, imageUrl: @series.imageUrl, ranking: @series.ranking, title: @series.title } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { category: @series.category, description: @series.description, imageUrl: @series.imageUrl, ranking: @series.ranking, title: @series.title } }
