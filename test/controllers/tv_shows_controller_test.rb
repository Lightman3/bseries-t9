...
class TvShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tv_show" do
    assert_difference('TvShow.count') do
      post tv_shows_url, params: { tv_show: { category: @tv_show.category, description: @tv_show.description, image_url: @tv_show.image_url, ranking: @tv_show.ranking, title: @tv_show.title } }
    end
  ...
  test "should update tv_show" do
    patch tv_show_url(@tv_show), params: { tv_show: { category: @tv_show.category, description: @tv_show.description, image_url: @tv_show.image_url, ranking: @tv_show.ranking, title: @tv_show.title } }
